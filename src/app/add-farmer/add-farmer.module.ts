...
@NgModule({
  declarations: [QuestionaryComponent, HeaderComponent, SidenavComponent, ConceptCardsComponent, DemographicInfoComponent, FieldInfoComponent, FinancialPlanningComponent, CropMarketPlanComponent, ProduceAggregatorComponent, TechnologyAdoptionComponent, CoApplicantComponent, InfoDeclarationComponent],
  imports: [CommonModule, RouterModule, AddFarmerRoutingModule],
})
