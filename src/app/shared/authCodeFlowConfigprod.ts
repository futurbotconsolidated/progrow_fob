...
export const authCodeFlowConfig: AuthConfig = {
  ...
  logoutUrl:
    'https://auth1.agrisaathi.com/logout?client_id=1806krf02bdr6a953e0mnk6l54&response_type=code&scope=openid+profile&redirect_uri='+window.location.origin+'/login',
