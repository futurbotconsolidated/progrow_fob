CREATE TABLE frcm_app.question_section(
	section_id varchar(100)  PRIMARY KEY NOT NULL,
	section_text varchar(1000) UNIQUE NOT null,
...
CREATE TABLE frcm_app.question_info(
	...
	FOREIGN KEY (question_type_id) REFERENCES frcm_app.question_type_info(question_type_id),
	UNIQUE(question_type_id,question_text)
);
...
CREATE TABLE frcm_app.farmer_basic_info(
	...
	FOREIGN KEY (pan_proof_id) REFERENCES frcm_app.pan_proof_data(pan_proof_id)
);
...
-- frcm_app.pan_proof_data definition

-- Drop table

-- DROP TABLE frcm_app.pan_proof_data;
...
CREATE TABLE frcm_app.pan_proof_data (
	...
	CONSTRAINT pan_proof_data_pan_card_number_key UNIQUE (pan_card_number),
	CONSTRAINT pan_proof_data_pkey PRIMARY KEY (pan_proof_id)
);
...
-- frcm_app.property_type_info definition

-- Drop table

-- DROP TABLE frcm_app.property_type_info;

CREATE TABLE frcm_app.property_type_info (
	property_type_id varchar(100) NOT NULL,
	property_type_name varchar(100) NOT NULL,
	CONSTRAINT property_type_info_pkey PRIMARY KEY (property_type_id),
	CONSTRAINT property_type_info_property_type_name_key UNIQUE (property_type_name)
);


-- frcm_app.question_type_info definition
